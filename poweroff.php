...
<form action="poweroff.php" method="post">
Name of the VM to be powered off:<input type="text" name="name"><br>
...
$arg = $_POST["name"];
if($arg) {
exec('python /var/www/html/scripts/misc/test-tmp.py --poweroff'.' '.EscapeShellArg("$arg").'', $temp);
