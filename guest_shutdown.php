...
<form action="guest_shutdown.php" method="post">
Name of the VM to guest shutdown:<input type="text" name="name"><br>
...
$arg = $_POST["name"];
if($arg) {
exec('python /var/www/html/scripts/misc/test-tmp.py --guest_shutdown'.' '.EscapeShellArg("$arg").'', $temp);
