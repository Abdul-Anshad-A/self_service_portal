...
<form action="guest_standby.php" method="post">
Name of the VM to guest reboot:<input type="text" name="name"><br>
...
$arg = $_POST["name"];
if($arg) {
exec('python /var/www/html/scripts/misc/test-tmp.py --guest_standby'.' '.EscapeShellArg("$arg").'', $temp);
